  ...
  <div class="max-w-7xl mx-auto">
      ...
      <div class="mt-8 bg-card border border-border rounded-lg p-6">
        <div class="flex items-center gap-3 mb-4">
          ...
          <h2 class="text-xl font-semibold text-foreground">Atividades Recentes</h2>
        </div>
        <div class="space-y-3">
          <div class="flex items-center gap-3 text-sm p-3 rounded-lg hover:bg-muted/50 transition-colors">
            <div class="p-2 bg-green-500/10 rounded-full">
              <CheckCircleIcon class="w-5 h-5 text-green-500" />
            </div>
            <span class="text-muted-foreground flex-1">Você completou a aula "Introdução à AA"</span>
          ...
          <div class="flex items-center gap-3 text-sm p-3 rounded-lg hover:bg-muted/50 transition-colors">
            ...
            <span class="text-muted-foreground flex-1">Nova resposta no seu comentário</span>
          ...
          <div class="flex items-center gap-3 text-sm p-3 rounded-lg hover:bg-muted/50 transition-colors">
            ...
            <span class="text-muted-foreground flex-1">Você completou o Dia 11 do desafio</span>
